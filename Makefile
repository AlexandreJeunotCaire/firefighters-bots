...
testDumbCaptain:
	javac -d bin -classpath bin/gui.jar -sourcepath src src/tests/TestRobotDumbCaptain.java

exeTestDumbCaptain:
	java -classpath bin:bin/gui.jar tests.TestRobotDumbCaptain cartes/carteSujet.map
